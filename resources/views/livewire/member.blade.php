    ...
    <div class="w-full py-4">
        <div class="border-b border-gray-200 mb-4">
            ...
            @else
                ...
                <button wire:click="Status('create')" class="btn btn-secondary">Add Member</button>
            @endif
            ...
            <div class="overflow-x-auto">
                                ...
                                <tr class="hover">
                                    ...
                                    <td>
                                        <div class="flex items-center justify-end gap-4 px-4">
                                            <button wire:click="preEdit ({{ $member->id }})"
                                            ...
                                            <button wire:click="preDelete({{ $member->id }})" class="btn btn-danger">
                        ...
                        <form wire:submit.prevent="storeEdit">
                            ...
                            <div class="mt-4">
                                <label class="input input-bordered flex items-center gap-2">
                                    ...
                                    <input type="text" class="grow" placeholder="Email" wire:model='phone' />
                                    @error('phone')
                                        <span class="text-red-500">{{ $message }}</span>
                                    @enderror
                                </label>
                ...
                @elseif ($status == 'create')
                    <div>
                        <h1 class="text-2xl font-bold mb-4">Form Data Member</h1>
                        <form wire:submit.prevent="store">
                            ...
                            <div class="mt-4">
                                <label class="input input-bordered flex items-center gap-2">
                                    ...
                                    <input type="text" class="grow" placeholder="Nomor Telepon"
                                        wire:model='phone' />
                                    @error('phone')
                                        <span class="text-red-500">{{ $message }}</span>
                                    @enderror
